...
import {
    ...
    ErrorResponseToJSON,
    GroupCollectionModelFromJSON,
    GroupCollectionModelToJSON,
    GroupModelFromJSON,
    GroupModelToJSON,
    GroupWriteModelFromJSON,
    GroupWriteModelToJSON,
} from '../models/index';
...
export class GroupsApi extends runtime.BaseAPI {
     ...
     * Create group
     */
    async createGroupRaw(requestParameters: CreateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupModel>> {
        ...
        const response = await this.request({
            ...
            body: GroupWriteModelToJSON(requestParameters.groupWriteModel),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GroupModelFromJSON(jsonValue));
    }
     ...
     * Create group
     */
    async createGroup(requestParameters: CreateGroupRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupModel> {
    ...
    async deleteGroupRaw(requestParameters: DeleteGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/v3/groups/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get group
     */
    async getGroupRaw(requestParameters: GetGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * Get group
     */
    async getGroup(requestParameters: GetGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupModel> {
     ...
     * List groups
     */
    async listGroupsRaw(requestParameters: ListGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupCollectionModel>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GroupCollectionModelFromJSON(jsonValue));
    }
     ...
     * List groups
     */
    async listGroups(requestParameters: ListGroupsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupCollectionModel> {
     ...
     * Update group
     */
    async updateGroupRaw(requestParameters: UpdateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * Update group
     */
    async updateGroup(requestParameters: UpdateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupModel> {
