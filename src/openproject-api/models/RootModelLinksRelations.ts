...
/**
 * Check if a given object implements the RootModelLinksRelations interface.
 */
export function instanceOfRootModelLinksRelations(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksRelationsFromJSON(json: any): RootModelLinksRelations {
    return RootModelLinksRelationsFromJSONTyped(json, false);
}

export function RootModelLinksRelationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksRelations {
...
export function RootModelLinksRelationsToJSON(value?: RootModelLinksRelations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
