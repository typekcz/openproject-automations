...
/**
 * Check if a given object implements the NotificationModelLinksResource interface.
 */
export function instanceOfNotificationModelLinksResource(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksResourceFromJSON(json: any): NotificationModelLinksResource {
    return NotificationModelLinksResourceFromJSONTyped(json, false);
}

export function NotificationModelLinksResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksResource {
...
export function NotificationModelLinksResourceToJSON(value?: NotificationModelLinksResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
