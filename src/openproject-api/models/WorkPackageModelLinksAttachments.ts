...
/**
 * Check if a given object implements the WorkPackageModelLinksAttachments interface.
 */
export function instanceOfWorkPackageModelLinksAttachments(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAttachmentsFromJSON(json: any): WorkPackageModelLinksAttachments {
    return WorkPackageModelLinksAttachmentsFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAttachments {
...
export function WorkPackageModelLinksAttachmentsToJSON(value?: WorkPackageModelLinksAttachments | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
