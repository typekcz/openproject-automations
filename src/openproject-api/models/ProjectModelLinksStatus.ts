...
/**
 * Check if a given object implements the ProjectModelLinksStatus interface.
 */
export function instanceOfProjectModelLinksStatus(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksStatusFromJSON(json: any): ProjectModelLinksStatus {
    return ProjectModelLinksStatusFromJSONTyped(json, false);
}

export function ProjectModelLinksStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksStatus {
...
export function ProjectModelLinksStatusToJSON(value?: ProjectModelLinksStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
