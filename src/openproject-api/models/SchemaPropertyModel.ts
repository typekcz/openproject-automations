...
/**
 * Check if a given object implements the SchemaPropertyModel interface.
 */
export function instanceOfSchemaPropertyModel(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "required" in value;
    isInstance = isInstance && "hasDefault" in value;
    isInstance = isInstance && "writable" in value;

    return isInstance;
}

export function SchemaPropertyModelFromJSON(json: any): SchemaPropertyModel {
    return SchemaPropertyModelFromJSONTyped(json, false);
}

export function SchemaPropertyModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemaPropertyModel {
    ...
    return {
        ...
        'links': !exists(json, '_links') ? undefined : json['_links'],
    };
}

export function SchemaPropertyModelToJSON(value?: SchemaPropertyModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
