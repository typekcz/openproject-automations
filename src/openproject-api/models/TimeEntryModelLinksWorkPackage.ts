...
/**
 * Check if a given object implements the TimeEntryModelLinksWorkPackage interface.
 */
export function instanceOfTimeEntryModelLinksWorkPackage(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksWorkPackageFromJSON(json: any): TimeEntryModelLinksWorkPackage {
    return TimeEntryModelLinksWorkPackageFromJSONTyped(json, false);
}

export function TimeEntryModelLinksWorkPackageFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksWorkPackage {
...
export function TimeEntryModelLinksWorkPackageToJSON(value?: TimeEntryModelLinksWorkPackage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
