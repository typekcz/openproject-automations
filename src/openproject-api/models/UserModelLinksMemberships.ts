...
/**
 * Check if a given object implements the UserModelLinksMemberships interface.
 */
export function instanceOfUserModelLinksMemberships(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksMembershipsFromJSON(json: any): UserModelLinksMemberships {
    return UserModelLinksMembershipsFromJSONTyped(json, false);
}

export function UserModelLinksMembershipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksMemberships {
...
export function UserModelLinksMembershipsToJSON(value?: UserModelLinksMemberships | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
