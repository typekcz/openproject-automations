...
/**
 * Check if a given object implements the ProjectModelLinksTypes interface.
 */
export function instanceOfProjectModelLinksTypes(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksTypesFromJSON(json: any): ProjectModelLinksTypes {
    return ProjectModelLinksTypesFromJSONTyped(json, false);
}

export function ProjectModelLinksTypesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksTypes {
...
export function ProjectModelLinksTypesToJSON(value?: ProjectModelLinksTypes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
