...
/**
 * Check if a given object implements the RevisionModelLinksAuthor interface.
 */
export function instanceOfRevisionModelLinksAuthor(value: object): boolean {
    let isInstance = true;
...
export function RevisionModelLinksAuthorFromJSON(json: any): RevisionModelLinksAuthor {
    return RevisionModelLinksAuthorFromJSONTyped(json, false);
}

export function RevisionModelLinksAuthorFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionModelLinksAuthor {
...
export function RevisionModelLinksAuthorToJSON(value?: RevisionModelLinksAuthor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
