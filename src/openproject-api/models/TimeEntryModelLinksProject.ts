...
/**
 * Check if a given object implements the TimeEntryModelLinksProject interface.
 */
export function instanceOfTimeEntryModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksProjectFromJSON(json: any): TimeEntryModelLinksProject {
    return TimeEntryModelLinksProjectFromJSONTyped(json, false);
}

export function TimeEntryModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksProject {
...
export function TimeEntryModelLinksProjectToJSON(value?: TimeEntryModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
