...
/**
 * Check if a given object implements the QueryModelLinksStar interface.
 */
export function instanceOfQueryModelLinksStar(value: object): boolean {
    let isInstance = true;
...
export function QueryModelLinksStarFromJSON(json: any): QueryModelLinksStar {
    return QueryModelLinksStarFromJSONTyped(json, false);
}

export function QueryModelLinksStarFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryModelLinksStar {
...
export function QueryModelLinksStarToJSON(value?: QueryModelLinksStar | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
