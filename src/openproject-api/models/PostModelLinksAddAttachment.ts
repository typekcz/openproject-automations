...
/**
 * Check if a given object implements the PostModelLinksAddAttachment interface.
 */
export function instanceOfPostModelLinksAddAttachment(value: object): boolean {
    let isInstance = true;
...
export function PostModelLinksAddAttachmentFromJSON(json: any): PostModelLinksAddAttachment {
    return PostModelLinksAddAttachmentFromJSONTyped(json, false);
}

export function PostModelLinksAddAttachmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostModelLinksAddAttachment {
...
export function PostModelLinksAddAttachmentToJSON(value?: PostModelLinksAddAttachment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
