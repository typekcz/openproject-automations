...
/**
 * Check if a given object implements the TimeEntryModelLinksUpdateImmediately interface.
 */
export function instanceOfTimeEntryModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksUpdateImmediatelyFromJSON(json: any): TimeEntryModelLinksUpdateImmediately {
    return TimeEntryModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function TimeEntryModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksUpdateImmediately {
...
export function TimeEntryModelLinksUpdateImmediatelyToJSON(value?: TimeEntryModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
