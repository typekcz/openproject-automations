...
/**
 * Check if a given object implements the CategoryModelLinksSelf interface.
 */
export function instanceOfCategoryModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function CategoryModelLinksSelfFromJSON(json: any): CategoryModelLinksSelf {
    return CategoryModelLinksSelfFromJSONTyped(json, false);
}

export function CategoryModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryModelLinksSelf {
...
export function CategoryModelLinksSelfToJSON(value?: CategoryModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
