...
/**
 * Check if a given object implements the WorkPackageModelLinksAuthor interface.
 */
export function instanceOfWorkPackageModelLinksAuthor(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAuthorFromJSON(json: any): WorkPackageModelLinksAuthor {
    return WorkPackageModelLinksAuthorFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAuthorFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAuthor {
...
export function WorkPackageModelLinksAuthorToJSON(value?: WorkPackageModelLinksAuthor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
