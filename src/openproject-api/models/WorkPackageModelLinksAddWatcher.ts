...
/**
 * Check if a given object implements the WorkPackageModelLinksAddWatcher interface.
 */
export function instanceOfWorkPackageModelLinksAddWatcher(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAddWatcherFromJSON(json: any): WorkPackageModelLinksAddWatcher {
    return WorkPackageModelLinksAddWatcherFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAddWatcherFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAddWatcher {
...
export function WorkPackageModelLinksAddWatcherToJSON(value?: WorkPackageModelLinksAddWatcher | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
