...
/**
 * Check if a given object implements the NotificationModelLinksSelf interface.
 */
export function instanceOfNotificationModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksSelfFromJSON(json: any): NotificationModelLinksSelf {
    return NotificationModelLinksSelfFromJSONTyped(json, false);
}

export function NotificationModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksSelf {
...
export function NotificationModelLinksSelfToJSON(value?: NotificationModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
