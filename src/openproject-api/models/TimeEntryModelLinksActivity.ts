...
/**
 * Check if a given object implements the TimeEntryModelLinksActivity interface.
 */
export function instanceOfTimeEntryModelLinksActivity(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksActivityFromJSON(json: any): TimeEntryModelLinksActivity {
    return TimeEntryModelLinksActivityFromJSONTyped(json, false);
}

export function TimeEntryModelLinksActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksActivity {
...
export function TimeEntryModelLinksActivityToJSON(value?: TimeEntryModelLinksActivity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
