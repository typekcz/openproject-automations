...
/**
 * Check if a given object implements the FileLinkReadModelLinksSelf interface.
 */
export function instanceOfFileLinkReadModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksSelfFromJSON(json: any): FileLinkReadModelLinksSelf {
    return FileLinkReadModelLinksSelfFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksSelf {
...
export function FileLinkReadModelLinksSelfToJSON(value?: FileLinkReadModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
