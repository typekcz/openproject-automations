...
/**
 * Check if a given object implements the FileLinkWriteModelLinksOneOf1StorageUrl interface.
 */
export function instanceOfFileLinkWriteModelLinksOneOf1StorageUrl(value: object): boolean {
    let isInstance = true;
...
export function FileLinkWriteModelLinksOneOf1StorageUrlFromJSON(json: any): FileLinkWriteModelLinksOneOf1StorageUrl {
    return FileLinkWriteModelLinksOneOf1StorageUrlFromJSONTyped(json, false);
}

export function FileLinkWriteModelLinksOneOf1StorageUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkWriteModelLinksOneOf1StorageUrl {
...
export function FileLinkWriteModelLinksOneOf1StorageUrlToJSON(value?: FileLinkWriteModelLinksOneOf1StorageUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
