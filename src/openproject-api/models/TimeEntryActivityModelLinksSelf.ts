...
/**
 * Check if a given object implements the TimeEntryActivityModelLinksSelf interface.
 */
export function instanceOfTimeEntryActivityModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryActivityModelLinksSelfFromJSON(json: any): TimeEntryActivityModelLinksSelf {
    return TimeEntryActivityModelLinksSelfFromJSONTyped(json, false);
}

export function TimeEntryActivityModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryActivityModelLinksSelf {
...
export function TimeEntryActivityModelLinksSelfToJSON(value?: TimeEntryActivityModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
