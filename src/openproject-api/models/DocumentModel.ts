...
import type { DocumentModelLinks } from './DocumentModelLinks';
import {
    DocumentModelLinksFromJSON,
    DocumentModelLinksFromJSONTyped,
    DocumentModelLinksToJSON,
} from './DocumentModelLinks';
...
export function DocumentModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentModel {
    ...
    return {
        ...
        'links': !exists(json, '_links') ? undefined : DocumentModelLinksFromJSON(json['_links']),
    };
}
...
export function DocumentModelToJSON(value?: DocumentModel | null): any {
    ...
    return {
        ...
        '_links': DocumentModelLinksToJSON(value.links),
    };
}
