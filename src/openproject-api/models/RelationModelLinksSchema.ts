...
/**
 * Check if a given object implements the RelationModelLinksSchema interface.
 */
export function instanceOfRelationModelLinksSchema(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksSchemaFromJSON(json: any): RelationModelLinksSchema {
    return RelationModelLinksSchemaFromJSONTyped(json, false);
}

export function RelationModelLinksSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksSchema {
...
export function RelationModelLinksSchemaToJSON(value?: RelationModelLinksSchema | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
