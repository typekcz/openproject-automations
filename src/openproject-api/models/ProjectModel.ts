...
import type { ProjectModelLinks } from './ProjectModelLinks';
import {
    ProjectModelLinksFromJSON,
    ProjectModelLinksFromJSONTyped,
    ProjectModelLinksToJSON,
} from './ProjectModelLinks';
import type { ProjectModelStatusExplanation } from './ProjectModelStatusExplanation';
import {
    ProjectModelStatusExplanationFromJSON,
    ProjectModelStatusExplanationFromJSONTyped,
    ProjectModelStatusExplanationToJSON,
} from './ProjectModelStatusExplanation';
...
export function ProjectModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModel {
    ...
    return {
        ...
        'statusExplanation': !exists(json, 'statusExplanation') ? undefined : ProjectModelStatusExplanationFromJSON(json['statusExplanation']),
        '_public': !exists(json, 'public') ? undefined : json['public'],
        'description': !exists(json, 'description') ? undefined : FormattableFromJSON(json['description']),
        'createdAt': !exists(json, 'createdAt') ? undefined : (new Date(json['createdAt'])),
        'updatedAt': !exists(json, 'updatedAt') ? undefined : (new Date(json['updatedAt'])),
        'links': !exists(json, '_links') ? undefined : ProjectModelLinksFromJSON(json['_links']),
    };
}
...
export function ProjectModelToJSON(value?: ProjectModel | null): any {
    ...
    return {
        ...
        'name': value.name,
        'active': value.active,
        'statusExplanation': ProjectModelStatusExplanationToJSON(value.statusExplanation),
        'public': value._public,
        'description': FormattableToJSON(value.description),
        'createdAt': value.createdAt === undefined ? undefined : (value.createdAt.toISOString()),
        'updatedAt': value.updatedAt === undefined ? undefined : (value.updatedAt.toISOString()),
        '_links': ProjectModelLinksToJSON(value.links),
    };
}
