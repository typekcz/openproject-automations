...
/**
 * Check if a given object implements the WorkPackageModelLinksWatch interface.
 */
export function instanceOfWorkPackageModelLinksWatch(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksWatchFromJSON(json: any): WorkPackageModelLinksWatch {
    return WorkPackageModelLinksWatchFromJSONTyped(json, false);
}

export function WorkPackageModelLinksWatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksWatch {
...
export function WorkPackageModelLinksWatchToJSON(value?: WorkPackageModelLinksWatch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
