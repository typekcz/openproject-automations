...
/**
 * Check if a given object implements the FileLinkOriginDataModel interface.
 */
export function instanceOfFileLinkOriginDataModel(value: object): boolean {
    let isInstance = true;
...
export function FileLinkOriginDataModelFromJSON(json: any): FileLinkOriginDataModel {
    return FileLinkOriginDataModelFromJSONTyped(json, false);
}

export function FileLinkOriginDataModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkOriginDataModel {
...
export function FileLinkOriginDataModelToJSON(value?: FileLinkOriginDataModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
