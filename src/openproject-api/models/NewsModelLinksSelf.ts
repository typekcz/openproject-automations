...
/**
 * Check if a given object implements the NewsModelLinksSelf interface.
 */
export function instanceOfNewsModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function NewsModelLinksSelfFromJSON(json: any): NewsModelLinksSelf {
    return NewsModelLinksSelfFromJSONTyped(json, false);
}

export function NewsModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewsModelLinksSelf {
...
export function NewsModelLinksSelfToJSON(value?: NewsModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
