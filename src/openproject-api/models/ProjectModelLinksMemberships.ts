...
/**
 * Check if a given object implements the ProjectModelLinksMemberships interface.
 */
export function instanceOfProjectModelLinksMemberships(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksMembershipsFromJSON(json: any): ProjectModelLinksMemberships {
    return ProjectModelLinksMembershipsFromJSONTyped(json, false);
}

export function ProjectModelLinksMembershipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksMemberships {
...
export function ProjectModelLinksMembershipsToJSON(value?: ProjectModelLinksMemberships | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
