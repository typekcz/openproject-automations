...
/**
 * Check if a given object implements the RelationModelLinksUpdate interface.
 */
export function instanceOfRelationModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksUpdateFromJSON(json: any): RelationModelLinksUpdate {
    return RelationModelLinksUpdateFromJSONTyped(json, false);
}

export function RelationModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksUpdate {
...
export function RelationModelLinksUpdateToJSON(value?: RelationModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
