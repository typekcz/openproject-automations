...
/**
 * Check if a given object implements the AttachmentModelLinksAuthor interface.
 */
export function instanceOfAttachmentModelLinksAuthor(value: object): boolean {
    let isInstance = true;
...
export function AttachmentModelLinksAuthorFromJSON(json: any): AttachmentModelLinksAuthor {
    return AttachmentModelLinksAuthorFromJSONTyped(json, false);
}

export function AttachmentModelLinksAuthorFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentModelLinksAuthor {
...
export function AttachmentModelLinksAuthorToJSON(value?: AttachmentModelLinksAuthor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
