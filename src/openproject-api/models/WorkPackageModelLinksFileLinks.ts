...
/**
 * Check if a given object implements the WorkPackageModelLinksFileLinks interface.
 */
export function instanceOfWorkPackageModelLinksFileLinks(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksFileLinksFromJSON(json: any): WorkPackageModelLinksFileLinks {
    return WorkPackageModelLinksFileLinksFromJSONTyped(json, false);
}

export function WorkPackageModelLinksFileLinksFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksFileLinks {
...
export function WorkPackageModelLinksFileLinksToJSON(value?: WorkPackageModelLinksFileLinks | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
