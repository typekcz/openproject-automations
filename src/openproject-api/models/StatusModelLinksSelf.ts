...
/**
 * Check if a given object implements the StatusModelLinksSelf interface.
 */
export function instanceOfStatusModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function StatusModelLinksSelfFromJSON(json: any): StatusModelLinksSelf {
    return StatusModelLinksSelfFromJSONTyped(json, false);
}

export function StatusModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusModelLinksSelf {
...
export function StatusModelLinksSelfToJSON(value?: StatusModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
