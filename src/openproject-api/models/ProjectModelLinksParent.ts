...
/**
 * Check if a given object implements the ProjectModelLinksParent interface.
 */
export function instanceOfProjectModelLinksParent(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksParentFromJSON(json: any): ProjectModelLinksParent {
    return ProjectModelLinksParentFromJSONTyped(json, false);
}

export function ProjectModelLinksParentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksParent {
...
export function ProjectModelLinksParentToJSON(value?: ProjectModelLinksParent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
