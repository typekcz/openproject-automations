...
/**
 * Check if a given object implements the RelationModelLinksDelete interface.
 */
export function instanceOfRelationModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksDeleteFromJSON(json: any): RelationModelLinksDelete {
    return RelationModelLinksDeleteFromJSONTyped(json, false);
}

export function RelationModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksDelete {
...
export function RelationModelLinksDeleteToJSON(value?: RelationModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
