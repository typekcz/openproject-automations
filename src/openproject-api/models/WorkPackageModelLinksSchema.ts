...
/**
 * Check if a given object implements the WorkPackageModelLinksSchema interface.
 */
export function instanceOfWorkPackageModelLinksSchema(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksSchemaFromJSON(json: any): WorkPackageModelLinksSchema {
    return WorkPackageModelLinksSchemaFromJSONTyped(json, false);
}

export function WorkPackageModelLinksSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksSchema {
...
export function WorkPackageModelLinksSchemaToJSON(value?: WorkPackageModelLinksSchema | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
