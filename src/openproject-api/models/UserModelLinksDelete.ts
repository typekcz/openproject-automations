...
/**
 * Check if a given object implements the UserModelLinksDelete interface.
 */
export function instanceOfUserModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksDeleteFromJSON(json: any): UserModelLinksDelete {
    return UserModelLinksDeleteFromJSONTyped(json, false);
}

export function UserModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksDelete {
...
export function UserModelLinksDeleteToJSON(value?: UserModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
