...
/**
 * Check if a given object implements the CustomActionModelLinksExecuteImmediately interface.
 */
export function instanceOfCustomActionModelLinksExecuteImmediately(value: object): boolean {
    let isInstance = true;
...
export function CustomActionModelLinksExecuteImmediatelyFromJSON(json: any): CustomActionModelLinksExecuteImmediately {
    return CustomActionModelLinksExecuteImmediatelyFromJSONTyped(json, false);
}

export function CustomActionModelLinksExecuteImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomActionModelLinksExecuteImmediately {
...
export function CustomActionModelLinksExecuteImmediatelyToJSON(value?: CustomActionModelLinksExecuteImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
