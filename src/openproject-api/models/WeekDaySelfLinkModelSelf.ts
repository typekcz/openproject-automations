...
/**
 * Check if a given object implements the WeekDaySelfLinkModelSelf interface.
 */
export function instanceOfWeekDaySelfLinkModelSelf(value: object): boolean {
    let isInstance = true;
...
export function WeekDaySelfLinkModelSelfFromJSON(json: any): WeekDaySelfLinkModelSelf {
    return WeekDaySelfLinkModelSelfFromJSONTyped(json, false);
}

export function WeekDaySelfLinkModelSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): WeekDaySelfLinkModelSelf {
...
export function WeekDaySelfLinkModelSelfToJSON(value?: WeekDaySelfLinkModelSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
