...
/**
 * Check if a given object implements the RevisionModelLinksSelf interface.
 */
export function instanceOfRevisionModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function RevisionModelLinksSelfFromJSON(json: any): RevisionModelLinksSelf {
    return RevisionModelLinksSelfFromJSONTyped(json, false);
}

export function RevisionModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionModelLinksSelf {
...
export function RevisionModelLinksSelfToJSON(value?: RevisionModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
