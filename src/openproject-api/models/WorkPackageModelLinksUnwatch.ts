...
/**
 * Check if a given object implements the WorkPackageModelLinksUnwatch interface.
 */
export function instanceOfWorkPackageModelLinksUnwatch(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksUnwatchFromJSON(json: any): WorkPackageModelLinksUnwatch {
    return WorkPackageModelLinksUnwatchFromJSONTyped(json, false);
}

export function WorkPackageModelLinksUnwatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksUnwatch {
...
export function WorkPackageModelLinksUnwatchToJSON(value?: WorkPackageModelLinksUnwatch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
