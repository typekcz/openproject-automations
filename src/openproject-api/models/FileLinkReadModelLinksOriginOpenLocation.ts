...
/**
 * Check if a given object implements the FileLinkReadModelLinksOriginOpenLocation interface.
 */
export function instanceOfFileLinkReadModelLinksOriginOpenLocation(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksOriginOpenLocationFromJSON(json: any): FileLinkReadModelLinksOriginOpenLocation {
    return FileLinkReadModelLinksOriginOpenLocationFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksOriginOpenLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksOriginOpenLocation {
...
export function FileLinkReadModelLinksOriginOpenLocationToJSON(value?: FileLinkReadModelLinksOriginOpenLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
