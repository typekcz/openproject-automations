...
/**
 * Check if a given object implements the WorkPackageModelLinksAddFileLink interface.
 */
export function instanceOfWorkPackageModelLinksAddFileLink(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAddFileLinkFromJSON(json: any): WorkPackageModelLinksAddFileLink {
    return WorkPackageModelLinksAddFileLinkFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAddFileLinkFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAddFileLink {
...
export function WorkPackageModelLinksAddFileLinkToJSON(value?: WorkPackageModelLinksAddFileLink | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
