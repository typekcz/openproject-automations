...
/**
 * Check if a given object implements the GroupModelLinksSelf interface.
 */
export function instanceOfGroupModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function GroupModelLinksSelfFromJSON(json: any): GroupModelLinksSelf {
    return GroupModelLinksSelfFromJSONTyped(json, false);
}

export function GroupModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupModelLinksSelf {
...
export function GroupModelLinksSelfToJSON(value?: GroupModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
