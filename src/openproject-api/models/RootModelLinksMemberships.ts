...
/**
 * Check if a given object implements the RootModelLinksMemberships interface.
 */
export function instanceOfRootModelLinksMemberships(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksMembershipsFromJSON(json: any): RootModelLinksMemberships {
    return RootModelLinksMembershipsFromJSONTyped(json, false);
}

export function RootModelLinksMembershipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksMemberships {
...
export function RootModelLinksMembershipsToJSON(value?: RootModelLinksMemberships | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
