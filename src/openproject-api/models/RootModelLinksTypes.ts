...
/**
 * Check if a given object implements the RootModelLinksTypes interface.
 */
export function instanceOfRootModelLinksTypes(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksTypesFromJSON(json: any): RootModelLinksTypes {
    return RootModelLinksTypesFromJSONTyped(json, false);
}

export function RootModelLinksTypesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksTypes {
...
export function RootModelLinksTypesToJSON(value?: RootModelLinksTypes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
