...
/**
 * Check if a given object implements the RootModelLinksStatuses interface.
 */
export function instanceOfRootModelLinksStatuses(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksStatusesFromJSON(json: any): RootModelLinksStatuses {
    return RootModelLinksStatusesFromJSONTyped(json, false);
}

export function RootModelLinksStatusesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksStatuses {
...
export function RootModelLinksStatusesToJSON(value?: RootModelLinksStatuses | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
