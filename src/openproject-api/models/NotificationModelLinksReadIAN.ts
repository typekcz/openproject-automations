...
/**
 * Check if a given object implements the NotificationModelLinksReadIAN interface.
 */
export function instanceOfNotificationModelLinksReadIAN(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksReadIANFromJSON(json: any): NotificationModelLinksReadIAN {
    return NotificationModelLinksReadIANFromJSONTyped(json, false);
}

export function NotificationModelLinksReadIANFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksReadIAN {
...
export function NotificationModelLinksReadIANToJSON(value?: NotificationModelLinksReadIAN | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
