...
/**
 * Check if a given object implements the CategoryModelLinksProject interface.
 */
export function instanceOfCategoryModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function CategoryModelLinksProjectFromJSON(json: any): CategoryModelLinksProject {
    return CategoryModelLinksProjectFromJSONTyped(json, false);
}

export function CategoryModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryModelLinksProject {
...
export function CategoryModelLinksProjectToJSON(value?: CategoryModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
