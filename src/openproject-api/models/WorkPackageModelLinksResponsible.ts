...
/**
 * Check if a given object implements the WorkPackageModelLinksResponsible interface.
 */
export function instanceOfWorkPackageModelLinksResponsible(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksResponsibleFromJSON(json: any): WorkPackageModelLinksResponsible {
    return WorkPackageModelLinksResponsibleFromJSONTyped(json, false);
}

export function WorkPackageModelLinksResponsibleFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksResponsible {
...
export function WorkPackageModelLinksResponsibleToJSON(value?: WorkPackageModelLinksResponsible | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
