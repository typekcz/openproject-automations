...
/**
 * Check if a given object implements the RelationModelLinksTo interface.
 */
export function instanceOfRelationModelLinksTo(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksToFromJSON(json: any): RelationModelLinksTo {
    return RelationModelLinksToFromJSONTyped(json, false);
}

export function RelationModelLinksToFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksTo {
...
export function RelationModelLinksToToJSON(value?: RelationModelLinksTo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
