...
/**
 * Check if a given object implements the WorkPackageModelLinksType interface.
 */
export function instanceOfWorkPackageModelLinksType(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksTypeFromJSON(json: any): WorkPackageModelLinksType {
    return WorkPackageModelLinksTypeFromJSONTyped(json, false);
}

export function WorkPackageModelLinksTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksType {
...
export function WorkPackageModelLinksTypeToJSON(value?: WorkPackageModelLinksType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
