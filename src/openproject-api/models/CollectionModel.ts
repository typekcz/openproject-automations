 ...
 * @export
 */
export const CollectionModelTypeEnum = {
    Collection: 'Collection'
} as const;
export type CollectionModelTypeEnum = typeof CollectionModelTypeEnum[keyof typeof CollectionModelTypeEnum];
