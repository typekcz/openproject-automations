...
/**
 * Check if a given object implements the TimeEntryModelLinksSelf interface.
 */
export function instanceOfTimeEntryModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksSelfFromJSON(json: any): TimeEntryModelLinksSelf {
    return TimeEntryModelLinksSelfFromJSONTyped(json, false);
}

export function TimeEntryModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksSelf {
...
export function TimeEntryModelLinksSelfToJSON(value?: TimeEntryModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
