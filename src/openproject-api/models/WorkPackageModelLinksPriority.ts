...
/**
 * Check if a given object implements the WorkPackageModelLinksPriority interface.
 */
export function instanceOfWorkPackageModelLinksPriority(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksPriorityFromJSON(json: any): WorkPackageModelLinksPriority {
    return WorkPackageModelLinksPriorityFromJSONTyped(json, false);
}

export function WorkPackageModelLinksPriorityFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksPriority {
...
export function WorkPackageModelLinksPriorityToJSON(value?: WorkPackageModelLinksPriority | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
