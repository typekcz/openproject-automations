...
/**
 * Check if a given object implements the VersionModelLinksUpdateImmediately interface.
 */
export function instanceOfVersionModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function VersionModelLinksUpdateImmediatelyFromJSON(json: any): VersionModelLinksUpdateImmediately {
    return VersionModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function VersionModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionModelLinksUpdateImmediately {
...
export function VersionModelLinksUpdateImmediatelyToJSON(value?: VersionModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
