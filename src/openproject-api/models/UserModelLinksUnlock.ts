...
/**
 * Check if a given object implements the UserModelLinksUnlock interface.
 */
export function instanceOfUserModelLinksUnlock(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksUnlockFromJSON(json: any): UserModelLinksUnlock {
    return UserModelLinksUnlockFromJSONTyped(json, false);
}

export function UserModelLinksUnlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksUnlock {
...
export function UserModelLinksUnlockToJSON(value?: UserModelLinksUnlock | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
