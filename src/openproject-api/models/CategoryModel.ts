...
import type { CategoryModelLinks } from './CategoryModelLinks';
import {
    CategoryModelLinksFromJSON,
    CategoryModelLinksFromJSONTyped,
    CategoryModelLinksToJSON,
} from './CategoryModelLinks';
...
export function CategoryModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryModel {
    ...
    return {
        ...
        'links': !exists(json, '_links') ? undefined : CategoryModelLinksFromJSON(json['_links']),
    };
}
...
export function CategoryModelToJSON(value?: CategoryModel | null): any {
    ...
    return {
        ...
        'name': value.name,
        '_links': CategoryModelLinksToJSON(value.links),
    };
}
