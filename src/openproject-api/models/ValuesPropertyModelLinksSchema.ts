...
/**
 * Check if a given object implements the ValuesPropertyModelLinksSchema interface.
 */
export function instanceOfValuesPropertyModelLinksSchema(value: object): boolean {
    let isInstance = true;
...
export function ValuesPropertyModelLinksSchemaFromJSON(json: any): ValuesPropertyModelLinksSchema {
    return ValuesPropertyModelLinksSchemaFromJSONTyped(json, false);
}

export function ValuesPropertyModelLinksSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValuesPropertyModelLinksSchema {
...
export function ValuesPropertyModelLinksSchemaToJSON(value?: ValuesPropertyModelLinksSchema | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
