...
/**
 * Check if a given object implements the NewsModelLinksProject interface.
 */
export function instanceOfNewsModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function NewsModelLinksProjectFromJSON(json: any): NewsModelLinksProject {
    return NewsModelLinksProjectFromJSONTyped(json, false);
}

export function NewsModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewsModelLinksProject {
...
export function NewsModelLinksProjectToJSON(value?: NewsModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
