...
/**
 * Check if a given object implements the ProjectModelLinksWorkPackages interface.
 */
export function instanceOfProjectModelLinksWorkPackages(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksWorkPackagesFromJSON(json: any): ProjectModelLinksWorkPackages {
    return ProjectModelLinksWorkPackagesFromJSONTyped(json, false);
}

export function ProjectModelLinksWorkPackagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksWorkPackages {
...
export function ProjectModelLinksWorkPackagesToJSON(value?: ProjectModelLinksWorkPackages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
