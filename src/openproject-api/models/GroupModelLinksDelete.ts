...
/**
 * Check if a given object implements the GroupModelLinksDelete interface.
 */
export function instanceOfGroupModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function GroupModelLinksDeleteFromJSON(json: any): GroupModelLinksDelete {
    return GroupModelLinksDeleteFromJSONTyped(json, false);
}

export function GroupModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupModelLinksDelete {
...
export function GroupModelLinksDeleteToJSON(value?: GroupModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
