...
/**
 * Check if a given object implements the WorkPackageModelLinksProject interface.
 */
export function instanceOfWorkPackageModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksProjectFromJSON(json: any): WorkPackageModelLinksProject {
    return WorkPackageModelLinksProjectFromJSONTyped(json, false);
}

export function WorkPackageModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksProject {
...
export function WorkPackageModelLinksProjectToJSON(value?: WorkPackageModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
