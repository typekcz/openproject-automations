...
/**
 * Check if a given object implements the FileLinkReadModelLinksDelete interface.
 */
export function instanceOfFileLinkReadModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksDeleteFromJSON(json: any): FileLinkReadModelLinksDelete {
    return FileLinkReadModelLinksDeleteFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksDelete {
...
export function FileLinkReadModelLinksDeleteToJSON(value?: FileLinkReadModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
