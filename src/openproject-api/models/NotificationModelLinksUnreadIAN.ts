...
/**
 * Check if a given object implements the NotificationModelLinksUnreadIAN interface.
 */
export function instanceOfNotificationModelLinksUnreadIAN(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksUnreadIANFromJSON(json: any): NotificationModelLinksUnreadIAN {
    return NotificationModelLinksUnreadIANFromJSONTyped(json, false);
}

export function NotificationModelLinksUnreadIANFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksUnreadIAN {
...
export function NotificationModelLinksUnreadIANToJSON(value?: NotificationModelLinksUnreadIAN | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
