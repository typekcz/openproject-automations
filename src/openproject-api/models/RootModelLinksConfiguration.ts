...
/**
 * Check if a given object implements the RootModelLinksConfiguration interface.
 */
export function instanceOfRootModelLinksConfiguration(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksConfigurationFromJSON(json: any): RootModelLinksConfiguration {
    return RootModelLinksConfigurationFromJSONTyped(json, false);
}

export function RootModelLinksConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksConfiguration {
...
export function RootModelLinksConfigurationToJSON(value?: RootModelLinksConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
