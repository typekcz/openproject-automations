...
/**
 * Check if a given object implements the DocumentModelLinksSelf interface.
 */
export function instanceOfDocumentModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function DocumentModelLinksSelfFromJSON(json: any): DocumentModelLinksSelf {
    return DocumentModelLinksSelfFromJSONTyped(json, false);
}

export function DocumentModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentModelLinksSelf {
...
export function DocumentModelLinksSelfToJSON(value?: DocumentModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
