...
/**
 * Check if a given object implements the HelpTextModelLinksEditText interface.
 */
export function instanceOfHelpTextModelLinksEditText(value: object): boolean {
    let isInstance = true;
...
export function HelpTextModelLinksEditTextFromJSON(json: any): HelpTextModelLinksEditText {
    return HelpTextModelLinksEditTextFromJSONTyped(json, false);
}

export function HelpTextModelLinksEditTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): HelpTextModelLinksEditText {
...
export function HelpTextModelLinksEditTextToJSON(value?: HelpTextModelLinksEditText | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
