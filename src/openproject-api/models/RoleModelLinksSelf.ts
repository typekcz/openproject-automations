...
/**
 * Check if a given object implements the RoleModelLinksSelf interface.
 */
export function instanceOfRoleModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function RoleModelLinksSelfFromJSON(json: any): RoleModelLinksSelf {
    return RoleModelLinksSelfFromJSONTyped(json, false);
}

export function RoleModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleModelLinksSelf {
...
export function RoleModelLinksSelfToJSON(value?: RoleModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
