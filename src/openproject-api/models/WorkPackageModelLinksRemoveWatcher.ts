...
/**
 * Check if a given object implements the WorkPackageModelLinksRemoveWatcher interface.
 */
export function instanceOfWorkPackageModelLinksRemoveWatcher(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksRemoveWatcherFromJSON(json: any): WorkPackageModelLinksRemoveWatcher {
    return WorkPackageModelLinksRemoveWatcherFromJSONTyped(json, false);
}

export function WorkPackageModelLinksRemoveWatcherFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksRemoveWatcher {
...
export function WorkPackageModelLinksRemoveWatcherToJSON(value?: WorkPackageModelLinksRemoveWatcher | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
