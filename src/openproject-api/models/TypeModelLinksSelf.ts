...
/**
 * Check if a given object implements the TypeModelLinksSelf interface.
 */
export function instanceOfTypeModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function TypeModelLinksSelfFromJSON(json: any): TypeModelLinksSelf {
    return TypeModelLinksSelfFromJSONTyped(json, false);
}

export function TypeModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TypeModelLinksSelf {
...
export function TypeModelLinksSelfToJSON(value?: TypeModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
