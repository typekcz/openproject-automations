...
/**
 * Check if a given object implements the CustomOptionModelLinksSelf interface.
 */
export function instanceOfCustomOptionModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function CustomOptionModelLinksSelfFromJSON(json: any): CustomOptionModelLinksSelf {
    return CustomOptionModelLinksSelfFromJSONTyped(json, false);
}

export function CustomOptionModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomOptionModelLinksSelf {
...
export function CustomOptionModelLinksSelfToJSON(value?: CustomOptionModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
