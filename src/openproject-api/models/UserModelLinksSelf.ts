...
/**
 * Check if a given object implements the UserModelLinksSelf interface.
 */
export function instanceOfUserModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksSelfFromJSON(json: any): UserModelLinksSelf {
    return UserModelLinksSelfFromJSONTyped(json, false);
}

export function UserModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksSelf {
...
export function UserModelLinksSelfToJSON(value?: UserModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
