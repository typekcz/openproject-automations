...
/**
 * Check if a given object implements the WorkPackageModelLinksUpdateImmediately interface.
 */
export function instanceOfWorkPackageModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksUpdateImmediatelyFromJSON(json: any): WorkPackageModelLinksUpdateImmediately {
    return WorkPackageModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function WorkPackageModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksUpdateImmediately {
...
export function WorkPackageModelLinksUpdateImmediatelyToJSON(value?: WorkPackageModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
