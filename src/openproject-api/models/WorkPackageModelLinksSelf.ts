...
/**
 * Check if a given object implements the WorkPackageModelLinksSelf interface.
 */
export function instanceOfWorkPackageModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksSelfFromJSON(json: any): WorkPackageModelLinksSelf {
    return WorkPackageModelLinksSelfFromJSONTyped(json, false);
}

export function WorkPackageModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksSelf {
...
export function WorkPackageModelLinksSelfToJSON(value?: WorkPackageModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
