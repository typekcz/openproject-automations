...
/**
 * Check if a given object implements the UserModelLinksLock interface.
 */
export function instanceOfUserModelLinksLock(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksLockFromJSON(json: any): UserModelLinksLock {
    return UserModelLinksLockFromJSONTyped(json, false);
}

export function UserModelLinksLockFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksLock {
...
export function UserModelLinksLockToJSON(value?: UserModelLinksLock | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
