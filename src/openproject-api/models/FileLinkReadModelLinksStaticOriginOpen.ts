...
/**
 * Check if a given object implements the FileLinkReadModelLinksStaticOriginOpen interface.
 */
export function instanceOfFileLinkReadModelLinksStaticOriginOpen(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksStaticOriginOpenFromJSON(json: any): FileLinkReadModelLinksStaticOriginOpen {
    return FileLinkReadModelLinksStaticOriginOpenFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksStaticOriginOpenFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksStaticOriginOpen {
...
export function FileLinkReadModelLinksStaticOriginOpenToJSON(value?: FileLinkReadModelLinksStaticOriginOpen | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
