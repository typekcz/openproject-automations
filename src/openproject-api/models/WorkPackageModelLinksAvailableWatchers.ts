...
/**
 * Check if a given object implements the WorkPackageModelLinksAvailableWatchers interface.
 */
export function instanceOfWorkPackageModelLinksAvailableWatchers(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAvailableWatchersFromJSON(json: any): WorkPackageModelLinksAvailableWatchers {
    return WorkPackageModelLinksAvailableWatchersFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAvailableWatchersFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAvailableWatchers {
...
export function WorkPackageModelLinksAvailableWatchersToJSON(value?: WorkPackageModelLinksAvailableWatchers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
