...
/**
 * Check if a given object implements the ProjectModelLinksCreateWorkPackage interface.
 */
export function instanceOfProjectModelLinksCreateWorkPackage(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksCreateWorkPackageFromJSON(json: any): ProjectModelLinksCreateWorkPackage {
    return ProjectModelLinksCreateWorkPackageFromJSONTyped(json, false);
}

export function ProjectModelLinksCreateWorkPackageFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksCreateWorkPackage {
...
export function ProjectModelLinksCreateWorkPackageToJSON(value?: ProjectModelLinksCreateWorkPackage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
