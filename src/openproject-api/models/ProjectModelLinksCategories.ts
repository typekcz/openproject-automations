...
/**
 * Check if a given object implements the ProjectModelLinksCategories interface.
 */
export function instanceOfProjectModelLinksCategories(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksCategoriesFromJSON(json: any): ProjectModelLinksCategories {
    return ProjectModelLinksCategoriesFromJSONTyped(json, false);
}

export function ProjectModelLinksCategoriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksCategories {
...
export function ProjectModelLinksCategoriesToJSON(value?: ProjectModelLinksCategories | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
