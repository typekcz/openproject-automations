...
/**
 * Check if a given object implements the AttachmentModelLinksContainer interface.
 */
export function instanceOfAttachmentModelLinksContainer(value: object): boolean {
    let isInstance = true;
...
export function AttachmentModelLinksContainerFromJSON(json: any): AttachmentModelLinksContainer {
    return AttachmentModelLinksContainerFromJSONTyped(json, false);
}

export function AttachmentModelLinksContainerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentModelLinksContainer {
...
export function AttachmentModelLinksContainerToJSON(value?: AttachmentModelLinksContainer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
