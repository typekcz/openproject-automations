...
/**
 * Check if a given object implements the WorkPackageModelLinksTimeEntries interface.
 */
export function instanceOfWorkPackageModelLinksTimeEntries(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksTimeEntriesFromJSON(json: any): WorkPackageModelLinksTimeEntries {
    return WorkPackageModelLinksTimeEntriesFromJSONTyped(json, false);
}

export function WorkPackageModelLinksTimeEntriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksTimeEntries {
...
export function WorkPackageModelLinksTimeEntriesToJSON(value?: WorkPackageModelLinksTimeEntries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
