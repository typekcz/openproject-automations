...
/**
 * Check if a given object implements the TimeEntryModelLinksUser interface.
 */
export function instanceOfTimeEntryModelLinksUser(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksUserFromJSON(json: any): TimeEntryModelLinksUser {
    return TimeEntryModelLinksUserFromJSONTyped(json, false);
}

export function TimeEntryModelLinksUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksUser {
...
export function TimeEntryModelLinksUserToJSON(value?: TimeEntryModelLinksUser | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
