...
/**
 * Check if a given object implements the QueryModelLinksUpdateImmediately interface.
 */
export function instanceOfQueryModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function QueryModelLinksUpdateImmediatelyFromJSON(json: any): QueryModelLinksUpdateImmediately {
    return QueryModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function QueryModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryModelLinksUpdateImmediately {
...
export function QueryModelLinksUpdateImmediatelyToJSON(value?: QueryModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
