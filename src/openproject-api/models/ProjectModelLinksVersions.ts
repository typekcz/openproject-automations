...
/**
 * Check if a given object implements the ProjectModelLinksVersions interface.
 */
export function instanceOfProjectModelLinksVersions(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksVersionsFromJSON(json: any): ProjectModelLinksVersions {
    return ProjectModelLinksVersionsFromJSONTyped(json, false);
}

export function ProjectModelLinksVersionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksVersions {
...
export function ProjectModelLinksVersionsToJSON(value?: ProjectModelLinksVersions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
