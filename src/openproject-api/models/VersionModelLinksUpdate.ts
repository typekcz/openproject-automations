...
/**
 * Check if a given object implements the VersionModelLinksUpdate interface.
 */
export function instanceOfVersionModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function VersionModelLinksUpdateFromJSON(json: any): VersionModelLinksUpdate {
    return VersionModelLinksUpdateFromJSONTyped(json, false);
}

export function VersionModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionModelLinksUpdate {
...
export function VersionModelLinksUpdateToJSON(value?: VersionModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
