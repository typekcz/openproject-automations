...
/**
 * Check if a given object implements the WorkPackageModelLinksWatchers interface.
 */
export function instanceOfWorkPackageModelLinksWatchers(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksWatchersFromJSON(json: any): WorkPackageModelLinksWatchers {
    return WorkPackageModelLinksWatchersFromJSONTyped(json, false);
}

export function WorkPackageModelLinksWatchersFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksWatchers {
...
export function WorkPackageModelLinksWatchersToJSON(value?: WorkPackageModelLinksWatchers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
