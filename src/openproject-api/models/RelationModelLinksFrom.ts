...
/**
 * Check if a given object implements the RelationModelLinksFrom interface.
 */
export function instanceOfRelationModelLinksFrom(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksFromFromJSON(json: any): RelationModelLinksFrom {
    return RelationModelLinksFromFromJSONTyped(json, false);
}

export function RelationModelLinksFromFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksFrom {
...
export function RelationModelLinksFromToJSON(value?: RelationModelLinksFrom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
