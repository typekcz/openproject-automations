...
/**
 * Check if a given object implements the RevisionModelLinksShowRevision interface.
 */
export function instanceOfRevisionModelLinksShowRevision(value: object): boolean {
    let isInstance = true;
...
export function RevisionModelLinksShowRevisionFromJSON(json: any): RevisionModelLinksShowRevision {
    return RevisionModelLinksShowRevisionFromJSONTyped(json, false);
}

export function RevisionModelLinksShowRevisionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionModelLinksShowRevision {
...
export function RevisionModelLinksShowRevisionToJSON(value?: RevisionModelLinksShowRevision | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
