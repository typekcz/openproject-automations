...
/**
 * Check if a given object implements the ProjectModelLinksUpdate interface.
 */
export function instanceOfProjectModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksUpdateFromJSON(json: any): ProjectModelLinksUpdate {
    return ProjectModelLinksUpdateFromJSONTyped(json, false);
}

export function ProjectModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksUpdate {
...
export function ProjectModelLinksUpdateToJSON(value?: ProjectModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
