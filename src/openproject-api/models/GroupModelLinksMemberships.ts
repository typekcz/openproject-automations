...
/**
 * Check if a given object implements the GroupModelLinksMemberships interface.
 */
export function instanceOfGroupModelLinksMemberships(value: object): boolean {
    let isInstance = true;
...
export function GroupModelLinksMembershipsFromJSON(json: any): GroupModelLinksMemberships {
    return GroupModelLinksMembershipsFromJSONTyped(json, false);
}

export function GroupModelLinksMembershipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupModelLinksMemberships {
...
export function GroupModelLinksMembershipsToJSON(value?: GroupModelLinksMemberships | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
