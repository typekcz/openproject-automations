...
/**
 * Check if a given object implements the AttachmentModelLinksDownloadLocation interface.
 */
export function instanceOfAttachmentModelLinksDownloadLocation(value: object): boolean {
    let isInstance = true;
...
export function AttachmentModelLinksDownloadLocationFromJSON(json: any): AttachmentModelLinksDownloadLocation {
    return AttachmentModelLinksDownloadLocationFromJSONTyped(json, false);
}

export function AttachmentModelLinksDownloadLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentModelLinksDownloadLocation {
...
export function AttachmentModelLinksDownloadLocationToJSON(value?: AttachmentModelLinksDownloadLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
