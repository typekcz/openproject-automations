...
/**
 * Check if a given object implements the DayModelLinksWeekDay interface.
 */
export function instanceOfDayModelLinksWeekDay(value: object): boolean {
    let isInstance = true;
...
export function DayModelLinksWeekDayFromJSON(json: any): DayModelLinksWeekDay {
    return DayModelLinksWeekDayFromJSONTyped(json, false);
}

export function DayModelLinksWeekDayFromJSONTyped(json: any, ignoreDiscriminator: boolean): DayModelLinksWeekDay {
...
export function DayModelLinksWeekDayToJSON(value?: DayModelLinksWeekDay | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
