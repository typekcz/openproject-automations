...
/**
 * Check if a given object implements the NotificationModelLinksProject interface.
 */
export function instanceOfNotificationModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksProjectFromJSON(json: any): NotificationModelLinksProject {
    return NotificationModelLinksProjectFromJSONTyped(json, false);
}

export function NotificationModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksProject {
...
export function NotificationModelLinksProjectToJSON(value?: NotificationModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
