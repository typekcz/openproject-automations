...
/**
 * Check if a given object implements the RevisionModelLinksProject interface.
 */
export function instanceOfRevisionModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function RevisionModelLinksProjectFromJSON(json: any): RevisionModelLinksProject {
    return RevisionModelLinksProjectFromJSONTyped(json, false);
}

export function RevisionModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionModelLinksProject {
...
export function RevisionModelLinksProjectToJSON(value?: RevisionModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
