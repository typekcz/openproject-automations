...
/**
 * Check if a given object implements the PriorityModelLinksSelf interface.
 */
export function instanceOfPriorityModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function PriorityModelLinksSelfFromJSON(json: any): PriorityModelLinksSelf {
    return PriorityModelLinksSelfFromJSONTyped(json, false);
}

export function PriorityModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriorityModelLinksSelf {
...
export function PriorityModelLinksSelfToJSON(value?: PriorityModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
