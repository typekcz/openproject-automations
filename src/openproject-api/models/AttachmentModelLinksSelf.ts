...
/**
 * Check if a given object implements the AttachmentModelLinksSelf interface.
 */
export function instanceOfAttachmentModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function AttachmentModelLinksSelfFromJSON(json: any): AttachmentModelLinksSelf {
    return AttachmentModelLinksSelfFromJSONTyped(json, false);
}

export function AttachmentModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentModelLinksSelf {
...
export function AttachmentModelLinksSelfToJSON(value?: AttachmentModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
