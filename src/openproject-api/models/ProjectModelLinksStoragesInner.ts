...
/**
 * Check if a given object implements the ProjectModelLinksStoragesInner interface.
 */
export function instanceOfProjectModelLinksStoragesInner(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksStoragesInnerFromJSON(json: any): ProjectModelLinksStoragesInner {
    return ProjectModelLinksStoragesInnerFromJSONTyped(json, false);
}

export function ProjectModelLinksStoragesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksStoragesInner {
...
export function ProjectModelLinksStoragesInnerToJSON(value?: ProjectModelLinksStoragesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
