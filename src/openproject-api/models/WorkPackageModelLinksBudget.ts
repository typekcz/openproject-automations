...
/**
 * Check if a given object implements the WorkPackageModelLinksBudget interface.
 */
export function instanceOfWorkPackageModelLinksBudget(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksBudgetFromJSON(json: any): WorkPackageModelLinksBudget {
    return WorkPackageModelLinksBudgetFromJSONTyped(json, false);
}

export function WorkPackageModelLinksBudgetFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksBudget {
...
export function WorkPackageModelLinksBudgetToJSON(value?: WorkPackageModelLinksBudget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
