...
/**
 * Check if a given object implements the RootModelLinksSelf interface.
 */
export function instanceOfRootModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksSelfFromJSON(json: any): RootModelLinksSelf {
    return RootModelLinksSelfFromJSONTyped(json, false);
}

export function RootModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksSelf {
...
export function RootModelLinksSelfToJSON(value?: RootModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
