...
/**
 * Check if a given object implements the WorkPackageModelLinksPreviewMarkup interface.
 */
export function instanceOfWorkPackageModelLinksPreviewMarkup(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksPreviewMarkupFromJSON(json: any): WorkPackageModelLinksPreviewMarkup {
    return WorkPackageModelLinksPreviewMarkupFromJSONTyped(json, false);
}

export function WorkPackageModelLinksPreviewMarkupFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksPreviewMarkup {
...
export function WorkPackageModelLinksPreviewMarkupToJSON(value?: WorkPackageModelLinksPreviewMarkup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
