...
/**
 * Check if a given object implements the WorkPackageModelLinksRevisions interface.
 */
export function instanceOfWorkPackageModelLinksRevisions(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksRevisionsFromJSON(json: any): WorkPackageModelLinksRevisions {
    return WorkPackageModelLinksRevisionsFromJSONTyped(json, false);
}

export function WorkPackageModelLinksRevisionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksRevisions {
...
export function WorkPackageModelLinksRevisionsToJSON(value?: WorkPackageModelLinksRevisions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
