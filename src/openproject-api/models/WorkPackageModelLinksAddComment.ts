...
/**
 * Check if a given object implements the WorkPackageModelLinksAddComment interface.
 */
export function instanceOfWorkPackageModelLinksAddComment(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAddCommentFromJSON(json: any): WorkPackageModelLinksAddComment {
    return WorkPackageModelLinksAddCommentFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAddCommentFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAddComment {
...
export function WorkPackageModelLinksAddCommentToJSON(value?: WorkPackageModelLinksAddComment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
