...
/**
 * Check if a given object implements the WorkPackageModelLinksUpdate interface.
 */
export function instanceOfWorkPackageModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksUpdateFromJSON(json: any): WorkPackageModelLinksUpdate {
    return WorkPackageModelLinksUpdateFromJSONTyped(json, false);
}

export function WorkPackageModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksUpdate {
...
export function WorkPackageModelLinksUpdateToJSON(value?: WorkPackageModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
