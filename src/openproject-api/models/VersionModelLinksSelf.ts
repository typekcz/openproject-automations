...
/**
 * Check if a given object implements the VersionModelLinksSelf interface.
 */
export function instanceOfVersionModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function VersionModelLinksSelfFromJSON(json: any): VersionModelLinksSelf {
    return VersionModelLinksSelfFromJSONTyped(json, false);
}

export function VersionModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionModelLinksSelf {
...
export function VersionModelLinksSelfToJSON(value?: VersionModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
