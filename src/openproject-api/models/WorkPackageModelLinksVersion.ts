...
/**
 * Check if a given object implements the WorkPackageModelLinksVersion interface.
 */
export function instanceOfWorkPackageModelLinksVersion(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksVersionFromJSON(json: any): WorkPackageModelLinksVersion {
    return WorkPackageModelLinksVersionFromJSONTyped(json, false);
}

export function WorkPackageModelLinksVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksVersion {
...
export function WorkPackageModelLinksVersionToJSON(value?: WorkPackageModelLinksVersion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
