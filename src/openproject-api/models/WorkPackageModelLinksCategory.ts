...
/**
 * Check if a given object implements the WorkPackageModelLinksCategory interface.
 */
export function instanceOfWorkPackageModelLinksCategory(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksCategoryFromJSON(json: any): WorkPackageModelLinksCategory {
    return WorkPackageModelLinksCategoryFromJSONTyped(json, false);
}

export function WorkPackageModelLinksCategoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksCategory {
...
export function WorkPackageModelLinksCategoryToJSON(value?: WorkPackageModelLinksCategory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
