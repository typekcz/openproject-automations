...
/**
 * Check if a given object implements the NotificationModelLinksDetailsInner interface.
 */
export function instanceOfNotificationModelLinksDetailsInner(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksDetailsInnerFromJSON(json: any): NotificationModelLinksDetailsInner {
    return NotificationModelLinksDetailsInnerFromJSONTyped(json, false);
}

export function NotificationModelLinksDetailsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksDetailsInner {
...
export function NotificationModelLinksDetailsInnerToJSON(value?: NotificationModelLinksDetailsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
