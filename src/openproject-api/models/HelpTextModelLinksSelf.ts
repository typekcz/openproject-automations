...
/**
 * Check if a given object implements the HelpTextModelLinksSelf interface.
 */
export function instanceOfHelpTextModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function HelpTextModelLinksSelfFromJSON(json: any): HelpTextModelLinksSelf {
    return HelpTextModelLinksSelfFromJSONTyped(json, false);
}

export function HelpTextModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): HelpTextModelLinksSelf {
...
export function HelpTextModelLinksSelfToJSON(value?: HelpTextModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
