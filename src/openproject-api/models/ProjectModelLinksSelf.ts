...
/**
 * Check if a given object implements the ProjectModelLinksSelf interface.
 */
export function instanceOfProjectModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksSelfFromJSON(json: any): ProjectModelLinksSelf {
    return ProjectModelLinksSelfFromJSONTyped(json, false);
}

export function ProjectModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksSelf {
...
export function ProjectModelLinksSelfToJSON(value?: ProjectModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
