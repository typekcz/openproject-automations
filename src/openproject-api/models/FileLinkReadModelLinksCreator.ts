...
/**
 * Check if a given object implements the FileLinkReadModelLinksCreator interface.
 */
export function instanceOfFileLinkReadModelLinksCreator(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksCreatorFromJSON(json: any): FileLinkReadModelLinksCreator {
    return FileLinkReadModelLinksCreatorFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksCreatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksCreator {
...
export function FileLinkReadModelLinksCreatorToJSON(value?: FileLinkReadModelLinksCreator | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
