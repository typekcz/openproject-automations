...
/**
 * Check if a given object implements the FileLinkReadModelLinksOriginOpen interface.
 */
export function instanceOfFileLinkReadModelLinksOriginOpen(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksOriginOpenFromJSON(json: any): FileLinkReadModelLinksOriginOpen {
    return FileLinkReadModelLinksOriginOpenFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksOriginOpenFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksOriginOpen {
...
export function FileLinkReadModelLinksOriginOpenToJSON(value?: FileLinkReadModelLinksOriginOpen | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
