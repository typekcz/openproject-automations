...
/**
 * Check if a given object implements the FileLinkReadModelLinksContainer interface.
 */
export function instanceOfFileLinkReadModelLinksContainer(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksContainerFromJSON(json: any): FileLinkReadModelLinksContainer {
    return FileLinkReadModelLinksContainerFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksContainerFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksContainer {
...
export function FileLinkReadModelLinksContainerToJSON(value?: FileLinkReadModelLinksContainer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
