...
/**
 * Check if a given object implements the WorkPackageModelLinksStatus interface.
 */
export function instanceOfWorkPackageModelLinksStatus(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksStatusFromJSON(json: any): WorkPackageModelLinksStatus {
    return WorkPackageModelLinksStatusFromJSONTyped(json, false);
}

export function WorkPackageModelLinksStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksStatus {
...
export function WorkPackageModelLinksStatusToJSON(value?: WorkPackageModelLinksStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
