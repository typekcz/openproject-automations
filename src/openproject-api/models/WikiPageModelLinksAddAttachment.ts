...
/**
 * Check if a given object implements the WikiPageModelLinksAddAttachment interface.
 */
export function instanceOfWikiPageModelLinksAddAttachment(value: object): boolean {
    let isInstance = true;
...
export function WikiPageModelLinksAddAttachmentFromJSON(json: any): WikiPageModelLinksAddAttachment {
    return WikiPageModelLinksAddAttachmentFromJSONTyped(json, false);
}

export function WikiPageModelLinksAddAttachmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): WikiPageModelLinksAddAttachment {
...
export function WikiPageModelLinksAddAttachmentToJSON(value?: WikiPageModelLinksAddAttachment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
