...
import type { RoleModelLinks } from './RoleModelLinks';
import {
    RoleModelLinksFromJSON,
    RoleModelLinksFromJSONTyped,
    RoleModelLinksToJSON,
} from './RoleModelLinks';
 ...
 * @export
 */
export const RoleModelTypeEnum = {
    Role: 'Role'
} as const;
export type RoleModelTypeEnum = typeof RoleModelTypeEnum[keyof typeof RoleModelTypeEnum];
...
export function RoleModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleModel {
    ...
    return {
        ...
        'name': json['name'],
        'links': !exists(json, '_links') ? undefined : RoleModelLinksFromJSON(json['_links']),
    };
}
...
export function RoleModelToJSON(value?: RoleModel | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'name': value.name,
        '_links': RoleModelLinksToJSON(value.links),
    };
}
