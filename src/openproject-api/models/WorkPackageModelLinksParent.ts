...
/**
 * Check if a given object implements the WorkPackageModelLinksParent interface.
 */
export function instanceOfWorkPackageModelLinksParent(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksParentFromJSON(json: any): WorkPackageModelLinksParent {
    return WorkPackageModelLinksParentFromJSONTyped(json, false);
}

export function WorkPackageModelLinksParentFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksParent {
...
export function WorkPackageModelLinksParentToJSON(value?: WorkPackageModelLinksParent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
