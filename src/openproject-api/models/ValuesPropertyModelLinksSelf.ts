...
/**
 * Check if a given object implements the ValuesPropertyModelLinksSelf interface.
 */
export function instanceOfValuesPropertyModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function ValuesPropertyModelLinksSelfFromJSON(json: any): ValuesPropertyModelLinksSelf {
    return ValuesPropertyModelLinksSelfFromJSONTyped(json, false);
}

export function ValuesPropertyModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValuesPropertyModelLinksSelf {
...
export function ValuesPropertyModelLinksSelfToJSON(value?: ValuesPropertyModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
