...
/**
 * Check if a given object implements the VersionModelLinksAvailableInProjects interface.
 */
export function instanceOfVersionModelLinksAvailableInProjects(value: object): boolean {
    let isInstance = true;
...
export function VersionModelLinksAvailableInProjectsFromJSON(json: any): VersionModelLinksAvailableInProjects {
    return VersionModelLinksAvailableInProjectsFromJSONTyped(json, false);
}

export function VersionModelLinksAvailableInProjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionModelLinksAvailableInProjects {
...
export function VersionModelLinksAvailableInProjectsToJSON(value?: VersionModelLinksAvailableInProjects | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
