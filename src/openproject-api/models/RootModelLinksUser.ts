...
/**
 * Check if a given object implements the RootModelLinksUser interface.
 */
export function instanceOfRootModelLinksUser(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksUserFromJSON(json: any): RootModelLinksUser {
    return RootModelLinksUserFromJSONTyped(json, false);
}

export function RootModelLinksUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksUser {
...
export function RootModelLinksUserToJSON(value?: RootModelLinksUser | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
