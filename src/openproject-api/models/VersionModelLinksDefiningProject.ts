...
/**
 * Check if a given object implements the VersionModelLinksDefiningProject interface.
 */
export function instanceOfVersionModelLinksDefiningProject(value: object): boolean {
    let isInstance = true;
...
export function VersionModelLinksDefiningProjectFromJSON(json: any): VersionModelLinksDefiningProject {
    return VersionModelLinksDefiningProjectFromJSONTyped(json, false);
}

export function VersionModelLinksDefiningProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionModelLinksDefiningProject {
...
export function VersionModelLinksDefiningProjectToJSON(value?: VersionModelLinksDefiningProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
