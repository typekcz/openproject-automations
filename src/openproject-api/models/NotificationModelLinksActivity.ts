...
/**
 * Check if a given object implements the NotificationModelLinksActivity interface.
 */
export function instanceOfNotificationModelLinksActivity(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksActivityFromJSON(json: any): NotificationModelLinksActivity {
    return NotificationModelLinksActivityFromJSONTyped(json, false);
}

export function NotificationModelLinksActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksActivity {
...
export function NotificationModelLinksActivityToJSON(value?: NotificationModelLinksActivity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
