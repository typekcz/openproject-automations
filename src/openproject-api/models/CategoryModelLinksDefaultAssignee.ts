...
/**
 * Check if a given object implements the CategoryModelLinksDefaultAssignee interface.
 */
export function instanceOfCategoryModelLinksDefaultAssignee(value: object): boolean {
    let isInstance = true;
...
export function CategoryModelLinksDefaultAssigneeFromJSON(json: any): CategoryModelLinksDefaultAssignee {
    return CategoryModelLinksDefaultAssigneeFromJSONTyped(json, false);
}

export function CategoryModelLinksDefaultAssigneeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryModelLinksDefaultAssignee {
...
export function CategoryModelLinksDefaultAssigneeToJSON(value?: CategoryModelLinksDefaultAssignee | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
