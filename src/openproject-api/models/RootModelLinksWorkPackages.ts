...
/**
 * Check if a given object implements the RootModelLinksWorkPackages interface.
 */
export function instanceOfRootModelLinksWorkPackages(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksWorkPackagesFromJSON(json: any): RootModelLinksWorkPackages {
    return RootModelLinksWorkPackagesFromJSONTyped(json, false);
}

export function RootModelLinksWorkPackagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksWorkPackages {
...
export function RootModelLinksWorkPackagesToJSON(value?: RootModelLinksWorkPackages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
