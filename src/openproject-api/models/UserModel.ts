...
import type { UserModelLinks } from './UserModelLinks';
import {
    UserModelLinksFromJSON,
    UserModelLinksFromJSONTyped,
    UserModelLinksToJSON,
} from './UserModelLinks';
...
export function UserModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModel {
    ...
    return {
        ...
        'links': UserModelLinksFromJSON(json['_links']),
    };
}
...
export function UserModelToJSON(value?: UserModel | null): any {
    ...
    return {
        ...
        '_links': UserModelLinksToJSON(value.links),
    };
}
