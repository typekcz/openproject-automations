...
/**
 * Check if a given object implements the QueryFilterInstanceSchemaModelLinksSelf interface.
 */
export function instanceOfQueryFilterInstanceSchemaModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function QueryFilterInstanceSchemaModelLinksSelfFromJSON(json: any): QueryFilterInstanceSchemaModelLinksSelf {
    return QueryFilterInstanceSchemaModelLinksSelfFromJSONTyped(json, false);
}

export function QueryFilterInstanceSchemaModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryFilterInstanceSchemaModelLinksSelf {
...
export function QueryFilterInstanceSchemaModelLinksSelfToJSON(value?: QueryFilterInstanceSchemaModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
