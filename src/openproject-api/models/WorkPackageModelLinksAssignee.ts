...
/**
 * Check if a given object implements the WorkPackageModelLinksAssignee interface.
 */
export function instanceOfWorkPackageModelLinksAssignee(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAssigneeFromJSON(json: any): WorkPackageModelLinksAssignee {
    return WorkPackageModelLinksAssigneeFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAssigneeFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAssignee {
...
export function WorkPackageModelLinksAssigneeToJSON(value?: WorkPackageModelLinksAssignee | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
