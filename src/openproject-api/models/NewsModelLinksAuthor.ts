...
/**
 * Check if a given object implements the NewsModelLinksAuthor interface.
 */
export function instanceOfNewsModelLinksAuthor(value: object): boolean {
    let isInstance = true;
...
export function NewsModelLinksAuthorFromJSON(json: any): NewsModelLinksAuthor {
    return NewsModelLinksAuthorFromJSONTyped(json, false);
}

export function NewsModelLinksAuthorFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewsModelLinksAuthor {
...
export function NewsModelLinksAuthorToJSON(value?: NewsModelLinksAuthor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
