...
/**
 * Check if a given object implements the WorkPackageModelLinksRelations interface.
 */
export function instanceOfWorkPackageModelLinksRelations(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksRelationsFromJSON(json: any): WorkPackageModelLinksRelations {
    return WorkPackageModelLinksRelationsFromJSONTyped(json, false);
}

export function WorkPackageModelLinksRelationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksRelations {
...
export function WorkPackageModelLinksRelationsToJSON(value?: WorkPackageModelLinksRelations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
