...
/**
 * Check if a given object implements the DocumentModelLinksAttachments interface.
 */
export function instanceOfDocumentModelLinksAttachments(value: object): boolean {
    let isInstance = true;
...
export function DocumentModelLinksAttachmentsFromJSON(json: any): DocumentModelLinksAttachments {
    return DocumentModelLinksAttachmentsFromJSONTyped(json, false);
}

export function DocumentModelLinksAttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentModelLinksAttachments {
...
export function DocumentModelLinksAttachmentsToJSON(value?: DocumentModelLinksAttachments | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
