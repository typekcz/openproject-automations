...
/**
 * Check if a given object implements the BudgetModelLinksSelf interface.
 */
export function instanceOfBudgetModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function BudgetModelLinksSelfFromJSON(json: any): BudgetModelLinksSelf {
    return BudgetModelLinksSelfFromJSONTyped(json, false);
}

export function BudgetModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetModelLinksSelf {
...
export function BudgetModelLinksSelfToJSON(value?: BudgetModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
