...
/**
 * Check if a given object implements the RootModelLinksTimeEntries interface.
 */
export function instanceOfRootModelLinksTimeEntries(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksTimeEntriesFromJSON(json: any): RootModelLinksTimeEntries {
    return RootModelLinksTimeEntriesFromJSONTyped(json, false);
}

export function RootModelLinksTimeEntriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksTimeEntries {
...
export function RootModelLinksTimeEntriesToJSON(value?: RootModelLinksTimeEntries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
