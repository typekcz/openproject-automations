...
/**
 * Check if a given object implements the TimeEntryModelLinksUpdate interface.
 */
export function instanceOfTimeEntryModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksUpdateFromJSON(json: any): TimeEntryModelLinksUpdate {
    return TimeEntryModelLinksUpdateFromJSONTyped(json, false);
}

export function TimeEntryModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksUpdate {
...
export function TimeEntryModelLinksUpdateToJSON(value?: TimeEntryModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
