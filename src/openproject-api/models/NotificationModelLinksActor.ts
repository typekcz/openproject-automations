...
/**
 * Check if a given object implements the NotificationModelLinksActor interface.
 */
export function instanceOfNotificationModelLinksActor(value: object): boolean {
    let isInstance = true;
...
export function NotificationModelLinksActorFromJSON(json: any): NotificationModelLinksActor {
    return NotificationModelLinksActorFromJSONTyped(json, false);
}

export function NotificationModelLinksActorFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationModelLinksActor {
...
export function NotificationModelLinksActorToJSON(value?: NotificationModelLinksActor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
