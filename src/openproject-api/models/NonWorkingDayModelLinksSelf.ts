...
/**
 * Check if a given object implements the NonWorkingDayModelLinksSelf interface.
 */
export function instanceOfNonWorkingDayModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function NonWorkingDayModelLinksSelfFromJSON(json: any): NonWorkingDayModelLinksSelf {
    return NonWorkingDayModelLinksSelfFromJSONTyped(json, false);
}

export function NonWorkingDayModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonWorkingDayModelLinksSelf {
...
export function NonWorkingDayModelLinksSelfToJSON(value?: NonWorkingDayModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
