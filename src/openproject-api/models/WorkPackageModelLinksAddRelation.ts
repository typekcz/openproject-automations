...
/**
 * Check if a given object implements the WorkPackageModelLinksAddRelation interface.
 */
export function instanceOfWorkPackageModelLinksAddRelation(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAddRelationFromJSON(json: any): WorkPackageModelLinksAddRelation {
    return WorkPackageModelLinksAddRelationFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAddRelationFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAddRelation {
...
export function WorkPackageModelLinksAddRelationToJSON(value?: WorkPackageModelLinksAddRelation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
