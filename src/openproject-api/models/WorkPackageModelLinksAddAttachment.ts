...
/**
 * Check if a given object implements the WorkPackageModelLinksAddAttachment interface.
 */
export function instanceOfWorkPackageModelLinksAddAttachment(value: object): boolean {
    let isInstance = true;
...
export function WorkPackageModelLinksAddAttachmentFromJSON(json: any): WorkPackageModelLinksAddAttachment {
    return WorkPackageModelLinksAddAttachmentFromJSONTyped(json, false);
}

export function WorkPackageModelLinksAddAttachmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkPackageModelLinksAddAttachment {
...
export function WorkPackageModelLinksAddAttachmentToJSON(value?: WorkPackageModelLinksAddAttachment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
