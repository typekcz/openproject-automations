...
/**
 * Check if a given object implements the RelationModelLinksSelf interface.
 */
export function instanceOfRelationModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksSelfFromJSON(json: any): RelationModelLinksSelf {
    return RelationModelLinksSelfFromJSONTyped(json, false);
}

export function RelationModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksSelf {
...
export function RelationModelLinksSelfToJSON(value?: RelationModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
