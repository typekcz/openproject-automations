...
/**
 * Check if a given object implements the AttachmentModelLinksDelete interface.
 */
export function instanceOfAttachmentModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function AttachmentModelLinksDeleteFromJSON(json: any): AttachmentModelLinksDelete {
    return AttachmentModelLinksDeleteFromJSONTyped(json, false);
}

export function AttachmentModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentModelLinksDelete {
...
export function AttachmentModelLinksDeleteToJSON(value?: AttachmentModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
