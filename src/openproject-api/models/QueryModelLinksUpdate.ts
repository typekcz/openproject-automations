...
/**
 * Check if a given object implements the QueryModelLinksUpdate interface.
 */
export function instanceOfQueryModelLinksUpdate(value: object): boolean {
    let isInstance = true;
...
export function QueryModelLinksUpdateFromJSON(json: any): QueryModelLinksUpdate {
    return QueryModelLinksUpdateFromJSONTyped(json, false);
}

export function QueryModelLinksUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryModelLinksUpdate {
...
export function QueryModelLinksUpdateToJSON(value?: QueryModelLinksUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
