 ...
 */
export function instanceOfUpdateUserPreferencesRequest(value: object): boolean {
    let isInstance = true;
...
export function UpdateUserPreferencesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateUserPreferencesRequest {
    ...
    return {
        ...
        'autoHidePopups': !exists(json, 'autoHidePopups') ? undefined : json['autoHidePopups'],
        'timeZone': !exists(json, 'timeZone') ? undefined : json['timeZone'],
    };
}

export function UpdateUserPreferencesRequestToJSON(value?: UpdateUserPreferencesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'autoHidePopups': value.autoHidePopups,
