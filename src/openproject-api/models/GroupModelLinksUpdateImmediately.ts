...
/**
 * Check if a given object implements the GroupModelLinksUpdateImmediately interface.
 */
export function instanceOfGroupModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function GroupModelLinksUpdateImmediatelyFromJSON(json: any): GroupModelLinksUpdateImmediately {
    return GroupModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function GroupModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupModelLinksUpdateImmediately {
...
export function GroupModelLinksUpdateImmediatelyToJSON(value?: GroupModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
