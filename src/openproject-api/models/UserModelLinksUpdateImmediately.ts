...
/**
 * Check if a given object implements the UserModelLinksUpdateImmediately interface.
 */
export function instanceOfUserModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksUpdateImmediatelyFromJSON(json: any): UserModelLinksUpdateImmediately {
    return UserModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function UserModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksUpdateImmediately {
...
export function UserModelLinksUpdateImmediatelyToJSON(value?: UserModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
