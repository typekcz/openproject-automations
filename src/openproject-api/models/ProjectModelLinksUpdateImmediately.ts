...
/**
 * Check if a given object implements the ProjectModelLinksUpdateImmediately interface.
 */
export function instanceOfProjectModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksUpdateImmediatelyFromJSON(json: any): ProjectModelLinksUpdateImmediately {
    return ProjectModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function ProjectModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksUpdateImmediately {
...
export function ProjectModelLinksUpdateImmediatelyToJSON(value?: ProjectModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
