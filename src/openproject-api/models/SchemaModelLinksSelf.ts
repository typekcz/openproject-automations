...
/**
 * Check if a given object implements the SchemaModelLinksSelf interface.
 */
export function instanceOfSchemaModelLinksSelf(value: object): boolean {
    let isInstance = true;
...
export function SchemaModelLinksSelfFromJSON(json: any): SchemaModelLinksSelf {
    return SchemaModelLinksSelfFromJSONTyped(json, false);
}

export function SchemaModelLinksSelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemaModelLinksSelf {
...
export function SchemaModelLinksSelfToJSON(value?: SchemaModelLinksSelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
