...
/**
 * Check if a given object implements the ProjectModelLinksDelete interface.
 */
export function instanceOfProjectModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function ProjectModelLinksDeleteFromJSON(json: any): ProjectModelLinksDelete {
    return ProjectModelLinksDeleteFromJSONTyped(json, false);
}

export function ProjectModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectModelLinksDelete {
...
export function ProjectModelLinksDeleteToJSON(value?: ProjectModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
