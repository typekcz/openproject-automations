...
/**
 * Check if a given object implements the RootModelLinksUserPreferences interface.
 */
export function instanceOfRootModelLinksUserPreferences(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksUserPreferencesFromJSON(json: any): RootModelLinksUserPreferences {
    return RootModelLinksUserPreferencesFromJSONTyped(json, false);
}

export function RootModelLinksUserPreferencesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksUserPreferences {
...
export function RootModelLinksUserPreferencesToJSON(value?: RootModelLinksUserPreferences | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
