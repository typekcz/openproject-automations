...
/**
 * Check if a given object implements the UserModelLinksShowUser interface.
 */
export function instanceOfUserModelLinksShowUser(value: object): boolean {
    let isInstance = true;
...
export function UserModelLinksShowUserFromJSON(json: any): UserModelLinksShowUser {
    return UserModelLinksShowUserFromJSONTyped(json, false);
}

export function UserModelLinksShowUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserModelLinksShowUser {
...
export function UserModelLinksShowUserToJSON(value?: UserModelLinksShowUser | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
