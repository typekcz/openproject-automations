...
/**
 * Check if a given object implements the FileLinkReadModelLinksStorage interface.
 */
export function instanceOfFileLinkReadModelLinksStorage(value: object): boolean {
    let isInstance = true;
...
export function FileLinkReadModelLinksStorageFromJSON(json: any): FileLinkReadModelLinksStorage {
    return FileLinkReadModelLinksStorageFromJSONTyped(json, false);
}

export function FileLinkReadModelLinksStorageFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileLinkReadModelLinksStorage {
...
export function FileLinkReadModelLinksStorageToJSON(value?: FileLinkReadModelLinksStorage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
