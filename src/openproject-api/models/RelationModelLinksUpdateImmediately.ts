...
/**
 * Check if a given object implements the RelationModelLinksUpdateImmediately interface.
 */
export function instanceOfRelationModelLinksUpdateImmediately(value: object): boolean {
    let isInstance = true;
...
export function RelationModelLinksUpdateImmediatelyFromJSON(json: any): RelationModelLinksUpdateImmediately {
    return RelationModelLinksUpdateImmediatelyFromJSONTyped(json, false);
}

export function RelationModelLinksUpdateImmediatelyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationModelLinksUpdateImmediately {
...
export function RelationModelLinksUpdateImmediatelyToJSON(value?: RelationModelLinksUpdateImmediately | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
