...
/**
 * Check if a given object implements the QueryModelLinksUnstar interface.
 */
export function instanceOfQueryModelLinksUnstar(value: object): boolean {
    let isInstance = true;
...
export function QueryModelLinksUnstarFromJSON(json: any): QueryModelLinksUnstar {
    return QueryModelLinksUnstarFromJSONTyped(json, false);
}

export function QueryModelLinksUnstarFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryModelLinksUnstar {
...
export function QueryModelLinksUnstarToJSON(value?: QueryModelLinksUnstar | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
