...
/**
 * Check if a given object implements the DocumentModelLinksProject interface.
 */
export function instanceOfDocumentModelLinksProject(value: object): boolean {
    let isInstance = true;
...
export function DocumentModelLinksProjectFromJSON(json: any): DocumentModelLinksProject {
    return DocumentModelLinksProjectFromJSONTyped(json, false);
}

export function DocumentModelLinksProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentModelLinksProject {
...
export function DocumentModelLinksProjectToJSON(value?: DocumentModelLinksProject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
