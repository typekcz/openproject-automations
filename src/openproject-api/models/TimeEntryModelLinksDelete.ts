...
/**
 * Check if a given object implements the TimeEntryModelLinksDelete interface.
 */
export function instanceOfTimeEntryModelLinksDelete(value: object): boolean {
    let isInstance = true;
...
export function TimeEntryModelLinksDeleteFromJSON(json: any): TimeEntryModelLinksDelete {
    return TimeEntryModelLinksDeleteFromJSONTyped(json, false);
}

export function TimeEntryModelLinksDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeEntryModelLinksDelete {
...
export function TimeEntryModelLinksDeleteToJSON(value?: TimeEntryModelLinksDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
