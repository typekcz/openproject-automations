...
/**
 * Check if a given object implements the RootModelLinksPriorities interface.
 */
export function instanceOfRootModelLinksPriorities(value: object): boolean {
    let isInstance = true;
...
export function RootModelLinksPrioritiesFromJSON(json: any): RootModelLinksPriorities {
    return RootModelLinksPrioritiesFromJSONTyped(json, false);
}

export function RootModelLinksPrioritiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RootModelLinksPriorities {
...
export function RootModelLinksPrioritiesToJSON(value?: RootModelLinksPriorities | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
